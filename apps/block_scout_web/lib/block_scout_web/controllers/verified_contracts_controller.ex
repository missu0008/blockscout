defmodule BlockScoutWeb.VerifiedContractsController do
  ...
  import BlockScoutWeb.Chain, only: [paging_options: 1, next_page_params: 3, split_list_by_page: 1, fetch_page_number: 1]
  ...
  def search_verified_contracts() do
  end
  ...
  defp search_query(%{"search" => search_string}) do
    IO.inspect(search_string, label: "search")
